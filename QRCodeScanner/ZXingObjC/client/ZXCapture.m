...
#warning 设置焦距
      ...
      if ([zxd lockForConfiguration:nil])
      {
          NSLog(@"VideoMaxZoomFactor: %f",zxd.activeFormat.videoMaxZoomFactor);
          if (zxd.activeFormat.videoMaxZoomFactor >= 2.0)
          {
              zxd.videoZoomFactor = 2.0;
          }
          [zxd unlockForConfiguration];
      }
  }
